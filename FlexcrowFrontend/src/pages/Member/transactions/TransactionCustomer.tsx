  ...
  React.useEffect(() => {
    const fetchTransactions = async () => {
      try {
        ...
        const response = await fetch(`${config.API_URL}/transactions?page=${currentPage}&recordPerPage=${recordsPerPage}&startIndex=${(currentPage - 1) * recordsPerPage}&customer_id=current`, {
          headers: {
